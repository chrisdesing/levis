                                    ...
                                    <div class="card-body text-secondary" style="display: block;">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="mb-1 col-md-6 ">
                                                <label for="id_provee" class="form-label">PROVEEDOR</label>
                                                <select class="form-select" id="id_provee" name="roles_id">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $contador_compra ?>" class="form-control" style="text-align: center;" hidden>
